...
module _ {m n : ℕ} where
    ...
    factor-p {zero}                 = PE.refl
    factor-p {suc zero}             = PE.refl
    factor-p {suc (suc zero)}       = PE.refl
    factor-p {suc (suc (suc zero))} = PE.refl
    ...
    factor-q {zero}                 = PE.refl
    factor-q {suc zero}             = PE.refl
    factor-q {suc (suc zero)}       = PE.refl
